                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <br><br>
                                <div class="btn btn-primary" data-toggle="modal" data-target="#modal-4">ITINERARY & PLANNER</div>
                                <br><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="" id="login-form"  method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" id="action_login" value="{{ route('login') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="user_type" value="1" type="hidden" class="form-control" name="user_type" >
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="register-form" class="" method="POST" >
                    {{ csrf_field() }}
                    <input type="hidden" id="action" value="{{ route('register') }}">
                    <div class="modal-header">
